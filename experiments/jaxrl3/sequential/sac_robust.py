...
flags.DEFINE_integer("timesteps", int(3e4), "Number of training steps.")
...
flags.DEFINE_string("exp_type", "basic_robust", "Kind of experiment.")
flags.DEFINE_integer("num_contexts", 1, "Number of contexts for robust setting.")
...
def main(_):
    ...
    if wandb_run is not None:
        ...
        returns_dir = (
            ...
            f"sac_robust_{FLAGS.num_contexts}__{FLAGS.env_name}__steps_{FLAGS.timesteps}__wid_{FLAGS.wrapper_id}__"
